...
if(topic == "warning"){
  document.getElementById("messages").innerHTML = '<span>측정을 시작합니다.</span>';
}
else{
  document.getElementById("messages").innerHTML = '<span>[ ' + topic + ' ] 측정을 시작합니다.</span><br/>';
}
...
function unsubscribe(topic) {
  ...
  if(topic == "warning"){
    document.getElementById("messages").innerHTML = '<span>측정을 종료합니다.</span><br/>';
  }
  else{
    document.getElementById("messages").innerHTML = '<span>[ ' + topic + ' ] 의 측정을 중단합니다.</span><br/>';
  }
...
function onMessageArrived(msg) { 
  ...
  if(msg.destinationName == "warning"){
    document.getElementById("warning").innerHTML += '<span>' + msg.payloadString + '<br/>' + now + '<br/></span><br/>';
  }
  else if (msg.destinationName == "temperature"){
    document.getElementById("aaa").innerHTML = '<span>현재 온도 : ' + msg.payloadString + '</span><br/>';
  }
  else if( msg.destinationName == "humidity"){
    document.getElementById("bbb").innerHTML = '<span>현재 습도 : ' + msg.payloadString + '</span><br/>';
  }
  else if( msg.destinationName == "illuminance"){
    document.getElementById("ccc").innerHTML = '<span>현재 조도 : ' + msg.payloadString + '</span><br/>';
  }
}
